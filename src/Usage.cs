...
/// </summary>
public sealed record ModelRates(string Match, string Display, double Input, double Output, double CacheWrite, double CacheRead)
{
...
public static class Pricing
{
    ...
    {
        new("claude-opus-5",   "Opus 5",     5.00, 25.00, 10.00, 0.50),
        new("claude-opus-4-8", "Opus 4.8",   5.00, 25.00, 10.00, 0.50),
        new("claude-opus-4-7", "Opus 4.7",   5.00, 25.00, 10.00, 0.50),
        new("claude-opus",     "Opus",       5.00, 25.00, 10.00, 0.50),
        new("claude-sonnet-5", "Sonnet 5",   2.00, 10.00,  4.00, 0.20),
        new("claude-sonnet",   "Sonnet",     3.00, 15.00,  6.00, 0.30),
        new("claude-haiku",    "Haiku 4.5",  1.00,  5.00,  2.00, 0.10),
        new("claude-fable",    "Fable 5.1", 10.00, 50.00, 20.00, 0.25),
    };

    private static readonly ModelRates Fallback = new("", "?", 5.00, 25.00, 10.00, 0.50);
